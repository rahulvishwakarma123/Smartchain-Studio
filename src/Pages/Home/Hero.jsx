    ...
    <>
      ...
      >
        ...
        <div className="flex flex-col max-sm:flex lg:basis-3/5 lg:pr-8">
          ...
          >
            <span className="text-center text-2xl font-bold text-gray-800 md:text-6xl lg:text-7xl">
              The Leading
            </span>
            <motion.img
            ...
            />
            <span className="text-center text-2xl font-bold text-black md:text-6xl lg:text-7xl">
              MLM
            </span>
          </motion.h2>
          ...
          <motion.h2
            className="mt-6 mb-6 text-4xl font-bold text-black sm:text-5xl md:mt-8 md:mb-8 md:text-6xl lg:text-7xl"
            variants={itemVariants}
          >
            Company in India
          </motion.h2>
        ...
        {/* Right Section */}
        <motion.div
          className="mt-2 lg:mt-0 lg:basis-1/3 flex-1"
          variants={containerVariants}
          initial="hidden"
          animate={isInView ? "visible" : "hidden"}
        >
          ...
          >
            <motion.img
              className="mx-auto max-w-xs duration-300 hover:scale-[1.1] md:mx-0 md:max-w-none max-sm:w-20 max-sm:h-20"
              src={getStartedImage}
              alt="Get Started Image"
              whileHover={{ scale: 1.05 }}
              transition={{ type: "spring", stiffness: 300 }}
            />
            <p className="text-center text-sm leading-7 md:text-left md:text-xl md:leading-8 max-sm:text-left">
